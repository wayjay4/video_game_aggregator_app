                            ...
                            {game['url'] && (
                                <div className="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                    <a href={game['url']} className="hover:text-gray-400">
                                        <svg className="w-5 h-5 fill-current" viewBox="0 0 16 17" fill="none">
                                            <path
                            ...
                            {game['social']['instagram'] && (
                                <div className="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                    <a href={game['social']['instagram']['url']} className="hover:text-gray-400">
                                        <svg className="w-5 h-5 fill-current" viewBox="0 0 16 18" fill="none">
                            ...
                            {game['social']['facebook'] && (
                                <div className="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                    <a href={game['social']['facebook']['url']} className="hover:text-gray-400">
                                        <svg className="w-5 h-5 fill-current" viewBox="0 0 14 16" fill="none">
                                            <path
                                        ...
                                        <div className="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                                            <div className="bg-gray-900 rounded">
                                                <div className="flex justify-end pr-4 pt-2">
                                                    <button
                                                        className="text-3xl leading-none text-amber-500 hover:text-red-600 flex items-center"
                                                        onClick={() => setIsTrailerModalVisible(false)}>
                            ...
                            {game['screenshots'] && game['screenshots'].map(screenshot => (
                                <div key={screenshot['id']}>
                                    <a href={screenshot['huge']}>
                                        <img src={screenshot['huge']} onClick={handleScreenshotOnClick}
                                             alt="game screenshot"
                        ...
                        <div style={{backgroundColor: "rgba(0,0,0,.5)"}}
                            ...
                            <div className="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                                <div className="bg-gray-900 rounded">
                                    ...
                                    <div className="modal-body px-8 py-8">
                                        <img src={currentScreenshotImage} alt="game screenshot"
                                             className="hover:opacity-75 transition ease-in-out duration-150"/>
                                    </div>
                                </div>
                            </div>
