        ...
        <div className="relative">
            ...
            {isLoading && (
                <div role="status" className="spinner top-0 right-0 mt-1.5 mr-4" style={{position: 'absolute'}}>
                    <svg ariaHidden="true" className="w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
