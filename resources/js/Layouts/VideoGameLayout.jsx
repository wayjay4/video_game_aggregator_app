                ...
                <nav className="container mx-auto flex flex-col space-y-6 lg:space-y-0 lg:flex-row items-center justify-between px-4 py-6">
                    ...
                    <div className="flex items-center">
                        <div className="relative">
                            <input type="text" name="search_query" id="search_query" className="bg-gray-800 text-sm rounded-full focus:outline-none focus:shadow-outline w-64 px-3 py-1 pl-8" placeholder="Search..." />
